				...
				<form action="<?= site_url('admin/proses_tambahProduk');?>" method="post" enctype="multipart/form-data">
					<div class="row">
						...
						<div class="col-md-3 border-left">
							<button type="submit" class="btn btn-primary btn-block btn-sm mb-4" id="send-button">tambahkan produk</button>
							<div class="form-group">
								<label for="inputPosterproduk">Poster produk <small class="text-danger">*</small></label>
								<input type="file" class="form-control" id="inputPosterproduk" name="poster">
							</div>
						</div>
					</div>
				</form>
